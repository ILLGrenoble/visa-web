...
@Component({
    selector: 'visa-admin-activated-users-count-stat',
    templateUrl: './activated-users-count.component.html',
})
export class ActivatedUsersCountComponent implements OnInit, OnDestroy {
        ...
        this.refresh$
            ...
            .subscribe(({data, loading, errors}) => {
                if (errors) {
                    ...
                    this.data = data.countActivatedUsers;
                }
