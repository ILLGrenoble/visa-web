...
@Component({
    selector: 'visa-admin-instance-count-stat',
    templateUrl: './instance-count-stat.component.html',
})
export class InstanceCountStatComponent implements OnInit, OnDestroy {
    ...
    public ngOnInit(): void {
        this.refresh$
            ...
            .subscribe(({data, loading, errors}) => {
                if (errors) {
                    this.notifierService.notify('error', `There was an error fetching the instance count`);
                } else {
                    this.data = data.countInstances;
                }
